    ...
    <footer class="h-24 bg-locationBtnActive w-full py-4">
      <p class="w-full flex justify-center items-center gap-6">
        <a
          href=""
          target="_blank"
          class="border-b border-transparent hover:border-black transition-all duration-200"
          >Figma Design</a
        >
        <a
          href=""
      ...
      <p class="text-white w-full flex justify-center items-center gap-1 mt-1">
        Made with
        <svg
          width="24"
          height="20"
